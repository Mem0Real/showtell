...
export const BentoCard: React.FC<BentoCardProps> = ({ item, onOpenModel }) => {
  ...
  return (
    ...
    >
      ...
      {/* Content */}
      <div className='absolute inset-0 p-6 py-2 flex flex-col justify-between'>
        {/* Top content */}
        <div>
          <motion.div
          ...
          <motion.div layout='position' className='relative'>
            ...
            <AnimatePresence mode='popLayout'>
              {isHovered && (
                ...
                >
                  <p className='text-white/90 text-sm mt-3 mb-4 line-clamp-2'>{item.description}</p>
      ...
      {/* 3D Badge */}
      {item.modelPath && (
        <div className='absolute top-8 right-4 bg-white/20 backdrop-blur-sm rounded-full p-2'>
      ...
      {/* Rating */}
      {item.stats && (
            <div className='absolute top-2 right-4 flex items-center gap-1 bg-white/20 backdrop-blur-sm rounded-lg px-2 py-1 w-fit'>
