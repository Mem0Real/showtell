            ...
            <AnimatePresence>
              {isLoading && (
                <motion.div
                  initial={{ opacity: 1 }}
                  exit={{ opacity: 0 }}
                  className='absolute inset-0 z-30 bg-gray-50 flex items-center justify-center'
                >
                  <div className='flex flex-col items-center gap-4'>
                    <div className='w-16 h-16 border-2 border-black/30 border-t-black rounded-full animate-spin' />
                    <p className='text-black text-lg'>Loading 3D Model...</p>
                  </div>
                </motion.div>
              )}
            </AnimatePresence>
