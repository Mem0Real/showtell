  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-3xl mx-auto px-4 py-24 md:py-32">
        {/* Header */}
        <div
          className={`text-center mb-16 transition-all duration-[80]
            ${isInView ? "opacity-100" : "opacity-20"}
          `}
          style={{ y: isInView ? 0 : 20 }}
        >
          <span
            className={`"inline-block px-4 py-1.5 bg-blue-100 text-blue-700 rounded-full text-sm font-medium mb-4 transition-all duration-500 delay-200
          ...
          <h2
            className={`text-5xl md:text-6xl font-bold text-gray-900 mb-4 ${playfair.className}`}
          >
        ...
        <div
          className={`"space-y-8 duration-[800] delay-[400]
        ...
        >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            {contactInfo.map((info, index) => (
              <a
                ...
                className="group p-4 bg-white/30 lg:bg-white rounded-xl border border-gray-200 hover:border-blue-200 hover:shadow-lg transition-all duration-500 hover:-mt-1"
                style={isInView ? { opacity: 1, y: 0 } : { opacity: 0, y: 20 }}
              >
          ...
          <form
            ...
            className="bg-white rounded-2xl p-6 md:p-8 border border-gray-200 shadow-sm transition-all duration-500 delay-800"
            style={isInView ? { opacity: 1, y: 0 } : { opacity: 0, y: 20 }}
          >
            ...
            <button
              ...
              className={`w-full py-3 px-6 rounded-full font-medium text-white transition-all duration-300 hover:scale-[1.02] active:scale-[0.98]  ${
          ...
          {/* Social Links */}
          <div
            className="flex items-center gap-4 justify-center transition-opacity duration-500 delay-1000"
            style={isInView ? { opacity: 1 } : { opacity: 0 }}
          >
            {socialLinks.map((social) => (
              <a
                ...
                hover:scale-[1.1] hover:rotate-[5] active:scale-[0.9]
                "
