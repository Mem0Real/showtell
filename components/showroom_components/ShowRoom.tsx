  ...
  return (
    <section className="w-full py-24 px-4 md:px-10">
      <div className="relative max-w-[85vw] mx-auto">
        {/* MAIN PANEL */}
        <div className="relative grid grid-cols-1 lg:grid-cols-2 gap-10 p-6 md:p-10 md:pr-16 bg-stone-900/80 md:bg-stone-900/90 border border-white/30 shadow-[0_10px_40px_rgba(0,0,0,0.1)] overflow-hidden clip-path-tablet lg:clip-path-desktop">
          ...
          <div className="relative z-10 flex flex-col justify-center">
            <h2
              className={` text-4xl md:text-5xl font-bold mb-4 text-neutral-200 ${playfair.className}`}
            >
              Explore Every Room
            </h2>

            <p className="text-neutral-300/70 leading-relaxed max-w-md">
              Step inside each space and experience how it feels to be there.
              Drag to look around and switch between rooms instantly.
            </p>
          </div>
