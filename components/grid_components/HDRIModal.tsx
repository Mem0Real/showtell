    ...
    <AnimatePresence>
      ...
      >
        ...
        >
          ...
          {/* Headers */}
          <div className="z-100 absolute top-4 right-3 flex gap-3 ">
            {/* Close Button */}
            <button
              onClick={onClose}
              className="p-2 rounded-lg hover:cursor-pointer bg-white/80 hover:bg-white shadow-sm border border-gray-200 transition text-gray-700"
            >
              <svg
                width="20"
                height="20"
